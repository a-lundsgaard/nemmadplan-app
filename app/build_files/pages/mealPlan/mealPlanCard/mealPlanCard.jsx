...
const prompt_1 = __importDefault(require("../../../components/shared/dialog/prompt/prompt"));
const imageGridList_1 = __importDefault(require("../../../components/shared/image/imageGrid/imageGridList"));
const viewMealPlanDialog_1 = __importDefault(require("../viewPlanDialog/viewMealPlanDialog"));
function MealPlanCard({ mealPlan, clikedPlan: clikedDish, dialogOpen, customDate, ...props }) {
    const useStyles = styles_1.default;
    const classes = useStyles();
    const [scrollDialogOpen, setScrollDialogOpen] = react_1.useState(0);
    ...
    return (<>
      ...
      <Card_1.default className={classes.card}>
        ...
        <viewMealPlanDialog_1.default mealPlan={mealPlan} visible={scrollDialogOpen} setVisible={bool => setScrollDialogOpen(bool)}/>
