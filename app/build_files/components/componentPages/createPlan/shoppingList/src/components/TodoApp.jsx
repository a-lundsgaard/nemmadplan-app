...
function TodoApp({ ingredientArray, updateAmountOnIngredients, ingredientsToDelete, defaultItems }) {
    return (<todos_context_jsx_1.TodosProvider ingredientArray={ingredientArray} updateAmountOnIngredients={updateAmountOnIngredients} ingredientsToDelete={ingredientsToDelete} defaultItems={defaultItems}>
